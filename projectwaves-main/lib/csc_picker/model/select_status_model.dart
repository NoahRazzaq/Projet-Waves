  ...
  Country.fromJson(Map<String, dynamic> json) {
    ...
    if (json['states'] != null) {
      ...
      json['states'].forEach((v) {
        state!.add(new Region.fromJson(v, id));
      });
    }
  }
...
class Region {
  ...
  Region.fromJson(Map<String, dynamic> json, country_id) {
    id = json['id'];
    name = json['name'];
    ...
    if (json['cities'] != null) {
      ...
      json['cities'].forEach((v) {
        city!.add(new City.fromJson(v, id));
      });
    }
  }
...
class City {
  ...
  City.fromJson(Map<String, dynamic> json, state_id) {
    id = json['id'];
    name = json['name'];
    stateId = state_id;
  }
